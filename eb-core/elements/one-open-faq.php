...
class Widget_EV_One_Open_FAQ_ACC extends Widget_Base
{
    public function get_name()
    {
        return 'eb-faq-acc-one';
    }
    public function get_title()
    {
        return esc_html__('One open FAQ Accordion', 'eb-core');
    }
...
Plugin::instance()->widgets_manager->register_widget_type(new Widget_EV_One_Open_FAQ_ACC());