...
class Widget_Client_Reviews_Slider extends Widget_Base
{
    public function get_name()
    {
        return 'client-reviews-slider';
    }
    public function get_title()
    {
        return esc_html__('Client Reviews Slider', 'eb-core');
    }
    ...
    protected function register_controls()
    {
        ...
        $repeater->add_control(
            'image',
            [
                'label' => __( 'Choose Client Photo', 'eb-core' ),
...
<section class="client-reviews-slider">
    ...
    <div class="owl-carousel owl-theme">
        ...
        <div class="item rev-item">
            ...
            <div class="client-photo">
                <img class="client-slider-img" src="<?php echo $slide['image']['url']; ?>">
            </div>
            <div class="carousel-item__card">
                ...
                <div class="client-info">
                    ...
                    <div class="client-deg"><?php echo $slide['client_designation']; ?></div>
                </div>
...
Plugin::instance()->widgets_manager->register_widget_type(new Widget_Client_Reviews_Slider());