...
* @since 1.0.0
*/
if( !function_exists( 'wcc_secure_redirect' ) ) :
    function wcc_secure_redirect() {
...
* @since 1.0.0
*/
if( !function_exists( 'wcc_country_list' ) ) :
    function wcc_country_list() {
