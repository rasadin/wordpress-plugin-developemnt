...
class Widget_EB_Orders_API_ACC extends Widget_Base
{
    public function get_name()
    {
        return 'eb-orders-api';
    }
    public function get_title()
    {
        return esc_html__('EB Order API List', 'apihub-core');
    }
    ...
    protected function render()
    {
        ...
        ?>
<!-- Add Markup Starts -->
<div id="order-accordion" class="commomn-api">
    <ul>
...
Plugin::instance()->widgets_manager->register_widget_type(new Widget_EB_Orders_API_ACC());