...
class Widget_WH_API_ACC extends Widget_Base
{
    public function get_name()
    {
        return 'webhook-api-acc';
    }
    public function get_title()
    {
        return esc_html__('EB Common API List', 'apihub-core');
    }
    ...
    protected function render()
    {
        ...
        ?>
<!-- Add Markup Starts -->
<div id="webhook-accordion" class="commomn-api">
    <ul>
...
Plugin::instance()->widgets_manager->register_widget_type(new Widget_WH_API_ACC());