...
class Widget_Order_API_ACC extends Widget_Base
{
    public function get_name()
    {
        return 'order-api-acc';
    }
    public function get_title()
    {
        return esc_html__('Order API', 'apihub-core');
    }
...
Plugin::instance()->widgets_manager->register_widget_type(new Widget_Order_API_ACC());