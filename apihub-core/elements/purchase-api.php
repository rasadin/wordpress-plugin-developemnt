...
class Widget_Purchase_API_ACC extends Widget_Base
{
    public function get_name()
    {
        return 'purchase-api-acc';
    }
    public function get_title()
    {
        return esc_html__('Purchase API', 'apihub-core');
    }
    ...
    protected function render()
    {
        ...
        ?>
<!-- Add Markup Starts -->
<div id="purchase-accordion" class="commomn-api">
    <ul>
...
Plugin::instance()->widgets_manager->register_widget_type(new Widget_Purchase_API_ACC());