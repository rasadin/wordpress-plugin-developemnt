...
class Widget_Portal_API_ACC extends Widget_Base
{
    public function get_name()
    {
        return 'portal-api-acc';
    }
    public function get_title()
    {
        return esc_html__('EB Me API List', 'apihub-core');
    }
    ...
    protected function render()
    {
        ...
        ?>
<!-- Add Markup Starts -->
<div id="portal-accordion" class="commomn-api">
    <ul>
        <?php foreach ($eb['hero_slides'] as $slide): ?>
            <li class="title-tog <?php echo do_shortcode(strtolower($slide['method'])); ?>">
                <a href="#<?php echo $slide['accordian_serial']; ?>" id="ti-<?php echo $slide['accordian_serial']; ?>"><span class="method-res"><?php echo do_shortcode($slide['method']); ?></span><span class="method-ti"><?php echo $slide['main_title']; ?></span></a>
                    ...
                    <div class="result-shortcode" style="display:none;" id="result1-<?php echo $slide['accordian_serial']; ?>">
                                <?php echo do_shortcode($slide['shortcode-1']); ?>
                            </div>
                                ...
                                <div class="response-btn">Example Response</div>
                                    <table class="exam-response-tb">
                                        ...
                                        <tr>
                                            ...
                                            <!-- <div class="scrollable-content"><pre class="response" name="response" readonly>
                                            <?php //echo do_shortcode($slide['shortcode-2']); ?>
                                            </pre></div> -->
...
Plugin::instance()->widgets_manager->register_widget_type(new Widget_Portal_API_ACC());