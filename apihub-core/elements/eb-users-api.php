...
class Widget_Usage_API_ACC extends Widget_Base
{
    public function get_name()
    {
        return 'usage-api-acc';
    }
    public function get_title()
    {
        return esc_html__('EB Users API List', 'apihub-core');
    }
    ...
    protected function render()
    {
        ...
        ?>
<!-- Add Markup Starts -->
<div id="usage-accordion" class="commomn-api">
    <ul>
...
Plugin::instance()->widgets_manager->register_widget_type(new Widget_Usage_API_ACC());