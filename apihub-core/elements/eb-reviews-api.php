...
class Widget_Trans_API_ACC extends Widget_Base
{
    public function get_name()
    {
        return 'trans-api-acc';
    }
    public function get_title()
    {
        return esc_html__('EB Reviews API List', 'apihub-core');
    }
    ...
    protected function render()
    {
        ...
        ?>
<!-- Add Markup Starts -->
<div id="trans-accordion" class="commomn-api">
    <ul>
...
Plugin::instance()->widgets_manager->register_widget_type(new Widget_Trans_API_ACC());