...
class Widget_Account_API_ACC extends Widget_Base
{
    public function get_name()
    {
        return 'account-api-acc';
    }
    public function get_title()
    {
        return esc_html__('EB Event API List', 'apihub-core');
    }
    ...
    protected function render()
    {
        ...
        ?>
<!-- Add Markup Starts -->
<div id="account-accordion" class="commomn-api">
    <ul>
        <?php foreach ($eb['hero_slides'] as $slide): ?>
            <li class="title-tog <?php echo do_shortcode(strtolower($slide['method'])); ?>">
                    ...
                    <div id="<?php echo $slide['accordian_serial']; ?>" class="accordion">
                        ...
                        <div class="try-or-cancel" style="display:block;">
...
Plugin::instance()->widgets_manager->register_widget_type(new Widget_Account_API_ACC());