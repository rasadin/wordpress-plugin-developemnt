...
class Widget_Events_API_ACC extends Widget_Base
{
    public function get_name()
    {
        return 'event-api-acc';
    }
    public function get_title()
    {
        return esc_html__('Event API', 'apihub-core');
    }
    ...
    protected function render()
    {
        ...
        ?>
<!-- Add Markup Starts -->
<div id="event-accordion" class="commomn-api">
    <ul>
...
Plugin::instance()->widgets_manager->register_widget_type(new Widget_Events_API_ACC());