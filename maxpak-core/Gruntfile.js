    ...
    grunt.initConfig({
        ...
        uglify: {
            ...
            my_target: {
                files: {
                    ...
                    '<%= dirs.dist %>/js/owl.carousel.min.js': [
        ...
        makepot: {
            target: {
                options: {
                    ...
                    potFilename: 'maxpak-core.pot', // Name of the POT file.
                    type: 'wp-plugin', // Type of project (wp-plugin or wp-theme).
                    potHeaders: {
                        'report-msgid-bugs-to': 'https://maxpak.com.au/',
        ...
        compress: {
            main: {
                options: {
                    mode: 'zip',
                    archive: './build/maxpak-core-v'+ pkg.version + '.zip'
                },
                expand: true,
                cwd: 'build/',
                src: ['**/*'],
