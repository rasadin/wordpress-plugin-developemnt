...
function batside_elementor_core_scripts_styles() {
    wp_enqueue_style('sthpen-owl-carousel', plugins_url('/assets/css/owl.carousel.min.css', __FILE__), '', rand());
    wp_enqueue_style('sthpen-owl-theme', plugins_url('/assets/css/owl.theme.default.min.css', __FILE__), '', rand());
    wp_enqueue_style('sthpen-public', plugins_url('/assets/css/public.css', __FILE__), '', rand());

    wp_enqueue_script('sthpen-owl-carousel', plugins_url('/assets/js/owl.carousel.min.js', __FILE__), array('jquery'), rand(), true);
    wp_enqueue_script('sthpen-public', plugins_url('/assets/js/public.js', __FILE__), array('jquery'), rand(), true);
    ...
    wp_localize_script('sthpen-public', 'public_localizer', $options);
}